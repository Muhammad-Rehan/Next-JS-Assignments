    ...
    return (
        <div className="w-80% border pt-[100px] sm:h-[200vh] font-mono pl-16 sm:w-[70%] m-auto text-justify pr-16">
            ...
            <ol>
                ...
                <li  className="pb-5"><span className="font-bold">2: Static Site Generation (SSG):  </span> With SSG, pages are pre-rendered at build time. This is ideal for content that doesn't change often. You can use getStaticProps and getStaticPaths for fetching data during the build process.</li>
